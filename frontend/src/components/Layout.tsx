...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: 'var(--color-canvas-default)' }}>
      {/* Header */}
      <header className="border-b border-[var(--color-border-default)] sticky top-0 z-40" style={{ background: 'rgba(250,250,249,0.95)', backdropFilter: 'blur(10px)' }}>
