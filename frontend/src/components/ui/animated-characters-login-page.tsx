...
export function AnimatedCharactersLoginPage() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-slate-800 via-slate-700 to-slate-800 p-12 text-white">
      ...
      <div className="flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold tracking-tight mb-2 text-gray-900">欢迎回来</h1>
            <p className="text-gray-500 text-sm">请输入您的账户信息</p>
          </div>

          {/* Login Form */}
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="email" className="text-sm font-medium text-gray-700">用户名</Label>
              <Input
                id="email"
                type="text"
                placeholder="admin"
                ...
                required
                className="h-12 bg-gray-50 border-gray-200 focus:border-[#6C3FF5] focus:ring-[#6C3FF5]"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-12 pr-10 bg-gray-50 border-gray-200 focus:border-[#6C3FF5] focus:ring-[#6C3FF5]"
                />
                <button
                  type="button"
            ...
            <Button
              type="submit"
              className="w-full h-12 text-base font-medium bg-[#6C3FF5] hover:bg-[#5B35E0]"
              size="lg"
              disabled={isLoading}
            >
              {isLoading ? "登录中..." : "登录"}
