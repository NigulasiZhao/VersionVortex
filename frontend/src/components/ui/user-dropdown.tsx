  ...
  return (
    <>
      <DropdownMenu>
        ...
        >
          <DropdownMenuItem
            className="cursor-pointer rounded-lg px-3 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-purple-50 dark:hover:bg-purple-900/20 focus:bg-purple-50 dark:focus:bg-purple-900/20"
          ...
          <DropdownMenuItem
            className="cursor-pointer rounded-lg px-3 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 focus:bg-red-50 dark:focus:bg-red-900/20"
            onClick={onLogout}
          >
