...
export async function initDb() {
  ...
  if (count.count === 0) {
    dbWrapper.prepare('INSERT INTO packages (name, description, homepage) VALUES (?, ?, ?)').run(
      'versionmanage-app', 'VersionVortex 客户端安装包', 'https://github.com/example/versionmanage'
    );
    dbWrapper.prepare('INSERT INTO packages (name, description, homepage) VALUES (?, ?, ?)').run(
      'versionmanage-cli', 'VersionVortex 命令行工具', 'https://github.com/example/versionmanage-cli'
    );
    dbWrapper.prepare('INSERT INTO packages (name, description, homepage) VALUES (?, ?, ?)').run(
      'versionmanage-sdk', 'VersionVortex SDK 开发包', 'https://github.com/example/versionmanage-sdk'
    );
    ...
    for (const pkg of packages) {
      if (pkg.name === 'versionmanage-app') {
        ...
        dbWrapper.prepare('INSERT INTO assets (release_id, name, size, download_count, file_path) VALUES (?, ?, ?, ?, ?)')
          .run(r1.lastInsertRowid, 'VersionVortex-2.1.0-win64.zip', 52428800, 156, 'sample/sample-win64.zip');
        dbWrapper.prepare('INSERT INTO assets (release_id, name, size, download_count, file_path) VALUES (?, ?, ?, ?, ?)')
          .run(r1.lastInsertRowid, 'VersionVortex-2.1.0-macos.dmg', 61200000, 89, 'sample/sample-macos.dmg');
        ...
        dbWrapper.prepare('INSERT INTO assets (release_id, name, size, download_count, file_path) VALUES (?, ?, ?, ?, ?)')
          .run(r2.lastInsertRowid, 'VersionVortex-2.0.5-win64.zip', 51000000, 234, 'sample/sample-win64.zip');
        ...
        dbWrapper.prepare('INSERT INTO assets (release_id, name, size, download_count, file_path) VALUES (?, ?, ?, ?, ?)')
          .run(r3.lastInsertRowid, 'VersionVortex-2.0.0-win64.zip', 55000000, 567, 'sample/sample-win64.zip');
        ...
        dbWrapper.prepare('INSERT INTO assets (release_id, name, size, download_count, file_path) VALUES (?, ?, ?, ?, ?)')
          .run(r4.lastInsertRowid, 'VersionVortex-1.9.0-win64.zip', 48000000, 890, 'sample/sample-win64.zip');
        ...
        dbWrapper.prepare('INSERT INTO assets (release_id, name, size, download_count, file_path) VALUES (?, ?, ?, ?, ?)')
          .run(r5.lastInsertRowid, 'VersionVortex-1.8.0-win64.zip', 46000000, 1200, 'sample/sample-win64.zip');
        ...
        dbWrapper.prepare('INSERT INTO assets (release_id, name, size, download_count, file_path) VALUES (?, ?, ?, ?, ?)')
          .run(r6.lastInsertRowid, 'VersionVortex-1.7.0-beta-win64.zip', 44000000, 2340, 'sample/sample-win64.zip');
        ...
        dbWrapper.prepare('INSERT INTO assets (release_id, name, size, download_count, file_path) VALUES (?, ?, ?, ?, ?)')
          .run(r7.lastInsertRowid, 'VersionVortex-1.6.0-win64.zip', 42000000, 3400, 'sample/sample-win64.zip');
        ...
        dbWrapper.prepare('INSERT INTO assets (release_id, name, size, download_count, file_path) VALUES (?, ?, ?, ?, ?)')
          .run(r8.lastInsertRowid, 'VersionVortex-1.5.0-draft-win64.zip', 40000000, 0, 'sample/sample-win64.zip');
      ...
      if (pkg.name === 'versionmanage-cli') {
        ...
        dbWrapper.prepare('INSERT INTO assets (release_id, name, size, download_count, file_path) VALUES (?, ?, ?, ?, ?)')
          .run(r1.lastInsertRowid, 'versionvortex-cli-1.3.0-linux.tar.gz', 8500000, 89, 'sample/sample-linux.tar.gz');
        ...
        dbWrapper.prepare('INSERT INTO assets (release_id, name, size, download_count, file_path) VALUES (?, ?, ?, ?, ?)')
          .run(r2.lastInsertRowid, 'versionvortex-cli-1.2.0-linux.tar.gz', 8200000, 234, 'sample/sample-linux.tar.gz');
        ...
        dbWrapper.prepare('INSERT INTO assets (release_id, name, size, download_count, file_path) VALUES (?, ?, ?, ?, ?)')
          .run(r3.lastInsertRowid, 'versionvortex-cli-1.1.0-linux.tar.gz', 7800000, 567, 'sample/sample-linux.tar.gz');
      }
      ...
      if (pkg.name === 'versionmanage-sdk') {
        ...
        dbWrapper.prepare('INSERT INTO assets (release_id, name, size, download_count, file_path) VALUES (?, ?, ?, ?, ?)')
          .run(r1.lastInsertRowid, 'versionvortex-sdk-1.0.0.tgz', 1200000, 45, 'sample/sample-win64.zip');
        ...
        dbWrapper.prepare('INSERT INTO assets (release_id, name, size, download_count, file_path) VALUES (?, ?, ?, ?, ?)')
          .run(r2.lastInsertRowid, 'versionvortex-sdk-0.9.0-beta.tgz', 1100000, 123, 'sample/sample-win64.zip');
      }
    }
  }
